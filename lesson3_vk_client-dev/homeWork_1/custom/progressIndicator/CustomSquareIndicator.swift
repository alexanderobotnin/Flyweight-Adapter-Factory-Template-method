...
class CustomSquareIndicator: UIActivityIndicatorView {
    ...
    override func startAnimating() {
        self.backgroundColor = UIColor.vkColor.brandBlue
        
        myLayer.path = nil
        myLayer.lineWidth = 4
        
        myLayer.strokeColor = UIColor.vkColor.brandWhite.cgColor
        myLayer.fillColor = UIColor.vkColor.brandLightBlue.cgColor
